...
<link rel="stylesheet"
	href="<?=base_url('assets/resources/css/ranking.css')?>">
...
<script src="<?=base_url('assets/resources/css/ranking.css')?>"></script>
...
<script
	src="<?=base_url('assets/resources/js/ranking/missionChart.js')?>"></script>
	...
	<div class="wrap sub leaderboard top100">
			...
			<div class="header_content">
				<div class="container">
					...
					<div class="menu_wrap">
						...
						<ul class="gnb">
							<li class="link hover"><a href="<?php echo base_url(); ?>"
								class="depth1">Inicio</a>
								<div class="depth2 on">
									<div>
										<ul>
											<li class="d2_gsc on"><a href="<?php echo base_url()?>"
												class="top100"> <span class="mcon"></span> <span
													class="text">Guild Top 100</span>
											</a></li>
											<li class="d2_top3"><a href="<?php echo base_url('Top3')?>"
												class="top100"><span class="mcon"></span><span class="text">
														Top3</span></a></li>
											...
											<li class="d2_ach"><a href="<?php echo base_url('Titulos')?>"
												class="top100"><span class="mcon"></span><span class="text">Titulos</span></a></li>
											<li class="d2_hp"><a href="<?php echo base_url('Honra')?>"
												class="top100"><span class="mcon"></span><span class="text">Honra</span></a></li>
											<li class="d2_ad"><a href="<?php echo base_url('PVP')?>"
												class="top100"><span class="mcon"></span><span class="text">Luta
														PVP</span></a></li>
											<li class="d2_mw"><a
												href="<?php echo base_url('MissionWar')?>" class="top100"><span
													class="mcon"></span><span class="text">Missão de Guerra</span></a></li>
										</ul>
									</div>
								</div></li>
							<li class="link"><a href="/characterRank" class="depth1">??? ??</a>
								<div class="depth2">
									<div>
										<ul>
											<li class="d2_ad"><a href="/characterRank/#/combat"><span
													class="mcon"></span><span class="text">?????</span></a></li>
											<li class="d2_wex"><a href="/characterRank/#/wexp"><span
													class="mcon"></span><span class="text">WEXP</span></a></li>
											<li class="d2_hp"><a href="/characterRank/#/honor"><span
													class="mcon"></span><span class="text">?? ??</span></a></li>
											<!-- ngIf: getNationCode() != 'tw' -->
											<li class="d2_dc"><a href="/characterRank/#/dungeonClear"><span
													class="mcon"></span><span class="text">?? ???</span></a></li>
											<!-- end ngIf: getNationCode() != 'tw' -->
											<li class="d2_mw"><a href="/characterRank/#/missionWar"><span
													class="mcon"></span><span class="text">?? ??</span></a></li>
							...
							<li class="link"><a href="/guildRank" class="depth1">?? ??</a>
								<div class="depth2">
									<div>
										<ul>
											<li class="d2_gsc"><a href="/guildRank/#/score"><span
													class="mcon"></span><span class="text ">?? ??</span></a></li>
											<li class="d2_wex"><a href="/guildRank/#/wexp"><span
													class="mcon"></span><span class="text">WEXP</span></a></li>
											<li class="d2_ach"><a href="/guildRank/#/achievement"><span
													class="mcon"></span><span class="text">??</span></a></li>
											<li class="d2_hp"><a href="/guildRank/#/honor"><span
													class="mcon"></span><span class="text">?? ??</span></a></li>
										</ul>
									</div>
								</div></li>
							<li class="sch"><a href="javascript:return false;" class="depth1">??</a>
								<div class="depth2">
		...
		<div class="section content ng-scope" id="content" ng-view="">
			<div class="container ng-scope"
				data-ng-init="searchCharacterLeaderTop100('combat', 'point_ad', 20)">
